...
short_curated_otus <- as.data.frame(curated_otus)
}
right_curated_otus <- right_lulu$curated_otus
right_curated_otus_df <- if (!is.data.frame(curated_otus)) {
right_curated_otus <- as.data.frame(curated_otus)
}
all_curated_otus <- rbind(right_curated_otus_df, short_curated_otus_df)
names(all_curated_otus)[names(all_curated_otus) == "right_curated_otus"] <- "all_filter_asvs"

write.csv(all_curated_otus, file = here("results/MiSeq16_all_curated_asvs_filtered_01.csv"), row.names = FALSE)
