...
names(right_curated_otus_df)[names(all_curated_otus) == "right_curated_otus"] <- "all_filter_asvs"
names(short_curated_otus_df)[names(all_curated_otus) == "short_curated_otus"] <- "all_filter_asvs"
