...
#short_read_tab <- mutate(short_read_tab, COICont10 = c(0))
right_read_tab <- mutate(right_read_tab, COICont10 = c(0), COICont8 = c(0), M6LGrep1 = c(0), M6LGrep3 = c(0))
```
...
# save dataframe
write.csv(final_df, file = "~/git/metabarcoding_workflow/results/PFAS_final_data_summary17_may_24.csv", row.names = FALSE)
