...
file_names <- list.files("~/git/metabarcoding_workflow/plants/data/raw")
...
write.table(samples, file = "~/git/metabarcoding_workflow/plants/data/metadata/samples.tsv", sep = "\t", row.names = FALSE, quote = FALSE)
```
