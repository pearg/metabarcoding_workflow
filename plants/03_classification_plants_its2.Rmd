...
load(here::here("plants/cache_its2/02.RData"))
```
...
# save threshold list
saveRDS(thresholds_list, file = "~/git/metabarcoding_workflow/plants/results_its2.thresholds_list_its2.rds") 
