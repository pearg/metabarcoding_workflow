...
file_names <- list.files("~/git/metabarcoding_workflow/18s/data/raw")
...
samples$filename_r1 <- paste0("./18s/data/raw/",samples$filename_r1)
samples$filename_r2 <- paste0("./18s/data/raw/",samples$filename_r2)

# Write table '.tsv' to analysis directory
write.table(samples, file = "~/git/metabarcoding_workflow/18s/data/metadata/samples.tsv", sep = "\t", row.names = FALSE, quote = FALSE)
```
