...
samples <- sample_list %>%
  mutate(
    filename_r1  = ifelse(grepl("R2", all_files), all_files, NA),
    filename_r2 = ifelse(grepl("R1", all_files), all_files, NA)
  )
...
samples <- samples %>%
  mutate(factor = sub("(rep1|rep2|rep3|rep4|rep5|rep6)$", "", factor))
