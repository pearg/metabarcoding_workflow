...
```{r}
#reset directory
uomshare <- "/home/unimelb.edu.au/uomShare/wergStaff/MelCarew/git-data/miseq17/metabarcoding_workflow/"
```
...
Sys.setenv(TMPDIR="/home/unimelb.edu.au/uomShare/wergStaff/MelCarew")
#tmp_dir_path <- "/mnt/galaxy/tmp"
tmp_dir_path <- "/home/unimelb.edu.au/mecarew/tmp"
```
...
threshold_file_list <- data.frame(
  ...
  file_list=c(paste0(uomshare, "classification/thresholds/short_files.txt"),
             paste0(uomshare, "classification/thresholds/right_files.txt"))
)
...
# WIP: For the moment, only run the short and right amplicons
write_targets(targets %>% filter(amplicon_group %in% c("right")), file=classification_targets)
```
