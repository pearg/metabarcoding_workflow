...
1.    Clone a copy of the workflow from the PEARG github repository https://github.com/pearg/metabarcoding_workflow into your server directory. You'll need a github account to do this (see - https://docs.github.com/en/get-started/onboarding/getting-started-with-your-github-account).

2.    Make a folder with your miseq run name for your data in git folder on the uomshare, then transfer data files from the AGRF server onto into your git folder on the uomshare in a folder called 'raw' (this is the folder name which these raw data files are accessed in the workflow)
...
metabarcoding_workflow <- "~/uomShare/wergStaff/MelCarew/git-data/miseq18/metabarcoding_workflow/"


if (dir.exists(metabarcoding_workflow)) {
...
# move raw data into the 'metabarcoding workflow' folder for analysis **change directory name to miseq datasewt**
file.rename(from = "mnt/uomShare/wergStaff/MelCarew/git-data/miseq18/raw", to = paste0(metabarcoding_workflow, "data/raw"))
