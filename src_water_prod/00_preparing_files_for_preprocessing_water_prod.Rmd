...
metabarcoding_workflow <- "~/uomShare/wergStaff/MelCarew/git-data/test/metabarcoding_workflow/"
...
file.rename(from = "~/uomShare/wergStaff/MelCarew/git-data/test/raw", to = paste0(metabarcoding_workflow, "data/raw"))
