...
```{r}
# set the working directory in the console
 setwd("~/git/metabarcoding_workflow")
```
...
Sys.setenv(PATH=paste0("/home/ubuntu/shared_envs/qiime2-2024.2/bin:/home/ubuntu/miniconda3/condabin:",
                       current_path_env))
Sys.setenv(PYTHONPATH="/home/ubuntu/shared_envs/qiime2-2024.2/lib/python3.8/site-packages/")
```
