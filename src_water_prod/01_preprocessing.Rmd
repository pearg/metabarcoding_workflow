...
results_dir <- "/mnt/uomShare/wergStaff/MelCarew/git_data/test/metabarcoding_workflow/results"

# Set the directory path for files to be stored on uomshare (NOTE: 'test' will need to be change to your miseq folder name)
uomshare <- "/mnt/uomShare/wergStaff/MelCarew/git_data/test/metabarcoding_workflow/"
