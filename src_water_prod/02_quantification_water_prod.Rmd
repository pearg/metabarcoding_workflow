...
```{r}
short_table <- read_qza(paste0(uomshare, "dada2/short_table.qza"))
short_table_df <- data.frame(short_table$data)
short_match_list <- read.table(paste0(uomshare, "lulu/short_match_list.txt"))
...
```{r}
right_table <- read_qza(file=paste0(uomshare, "dada2/right_table.qza"))
right_table_df <- data.frame(right_table$data)
right_match_list <- read.table(paste0(uomshare, "lulu/right_match_list.txt"))
